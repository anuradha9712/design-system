...
module.exports = {
  ...
  plugins: [
    ...
    `gatsby-transformer-json-key-value-to-array`,
    {
      ...
      options: {
        fonts: [
          'http://localhost:8000/static/MaterialIconsRound-Regular-d7e3f0d0d06a2e34f3c0eb0f12223240.otf',
          './node_modules/@innovaccer/design-system/css/material-design-icons/iconfont/MaterialIconsRound-Regular.otf',
          'material icons',
